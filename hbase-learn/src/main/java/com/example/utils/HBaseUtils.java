...
import com.example.config.HbaseConfig;
 ...
 * @Author: kevin yang
 * @Description:
 * @Date: create in 2020/9/24 16:56
 */
//@DependsOn("applicationContext")//控制依赖顺序，保证springContextHolder类在之前已经加载
@Slf4j
@Component
public class HBaseUtils {
    ...
    private static HbaseConfig hbaseConfig = (HbaseConfig) applicationContext.getBean("HbaseConfig");
